...
import com.example.algoritmogeneticosimple.R
import android.widget.EditText
import android.os.Bundle
import android.text.InputFilter
import com.example.algoritmogeneticosimple.InputFilterMinMax
import android.content.Intent
import android.util.Log
import android.view.View
import android.widget.Button
import android.widget.ProgressBar
import com.example.algoritmogeneticosimple.view_data_algoritmo
...
//            }
    ...
    fun completarbinarios(binary: String): String {
        val cantidaddigitos1 = binary.length
        var arr1 = binary
        if (cantidaddigitos1 < cromosomas) {
            for (i in cantidaddigitos1 until cromosomas) {
                arr1 = "0$arr1"
            }
        }
        return arr1
